...
DENTIA_PRODUCTION_WEBSITE_URL="${DENTIA_PRODUCTION_WEBSITE_URL:-http://127.0.0.1:3010}"
...
DENTIA_WEBSITE_CONTAINER="${DENTIA_WEBSITE_CONTAINER:-dentia-website}"
...
DENTIA_WEBSITE_SERVICE="${DENTIA_WEBSITE_SERVICE:-dentia-website}"
