...
const statusLabel: Record<string, string> = { DRAFT: "Borrador", READY_FOR_REVIEW: "Revisado por profesional", PENDING_SIGNATURE: "Pendiente de revisión del paciente", VOIDED: "Anulado" };
...
export function PatientConsentsWorkspace({ patientId, appointments, treatments, options, canRead, canCreate, canEdit, canReview, canVoid, canAudit, canIssueAccess, canReadAccess, canRevokeAccess, canReissueAccess, canManageClarifications, canViewAccessAudit }: Props) {
