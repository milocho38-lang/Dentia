...
- Esquema: `LIB1_NORM_V2_CONTEXTUAL`
- Documentos: 35
- Variantes: 70
- CO: 35
- CL: 35
- Estados por variante: {'BLOCKED': 36, 'NEEDS_REVIEW': 34}
- Estados por documento: {'BLOCKED': 18, 'NEEDS_REVIEW': 17}
- Clasificación por flujo: {'NO_PATIENT_SIGNATURE': 14, 'PATIENT_OR_RESPONSIBLE_ADULT': 13, 'SPECIAL_WORKFLOW': 4, 'RESPONSIBLE_ADULT_REQUIRED': 2, 'PATIENT_SELF': 2}

## Inventario por documento

| Código | Título | Categoría | CO | CL | Firmante | Causa | Línea | Término | Contexto |
|---|---|---|---|---|---|---|---:|---|---|
| CERT_ASISTENCIA | Certificado de asistencia | Administrativo | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| CONS_BLANQUEAMIENTO | Consentimiento informado de blanqueamiento dental | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_ORTODONCIA | Consentimiento informado de ortodoncia | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente/apoderado | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_NO_GARANTIA | Exención de garantía odontológica | Constancias y reconocimientos | BLOCKED | BLOCKED | SPECIAL_WORKFLOW | documento especial |  |  | Requiere un flujo especial todavía no implementado para consentimientos comunes. |
| CONS_CIRUGIA | Consentimiento informado de cirugía odontológica | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | tutor acompañante | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_DESTARTRAJE_OPERATORIA | Consentimiento de destartraje y operatoria dental | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 7 | paciente o tutor legal | CONSENTIMIENTO DESTARTRAJE Y OPERATORIA DENTAL Declaro haber informado de forma clara y veraz a el / la odontólogo/a tratante respecto a mi estado de salud general, condiciones médicas u odontológicas, tratamientos previos y actuales, alerg |
| CONS_IMPLANTOLOGIA | Consentimiento informado de implantología | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 7 | tutor acompañante | CONSENTIMIENTO IMPLANTOLOGÍA PROCEDIMIENTO ___ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo q |
| CONS_ODONTOPEDIATRIA | Consentimiento informado de odontopediatría | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | RESPONSIBLE_ADULT_REQUIRED | contenido pediátrico | 1 | odontopediatría | # Consentimiento informado de odontopediatría Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name} |
| RECHAZO_TRATAMIENTO | Rechazo de tratamiento odontológico, quirúrgico o diagnóstico | Rechazos | BLOCKED | BLOCKED | SPECIAL_WORKFLOW | documento especial |  |  | Requiere un flujo especial todavía no implementado para consentimientos comunes. |
| CONS_DESTARTRAJE | Consentimiento informado de destartraje | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_ENDODONCIA | Consentimiento informado de endodoncia | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_SELF | término administrativo | 5 | siendo responsable | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_OBTURACION_DIRECTA | Consentimiento informado de obturación directa | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_OBTURACION_BASE | Consentimiento informado de obturación directa con base cavitaria | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_PERIODONCIA | Consentimiento informado de periodoncia | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_PROTESIS_FIJA | Consentimiento informado de rehabilitación oral prótesis fija | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_PROTESIS_REMOVIBLE | Consentimiento informado de rehabilitación oral prótesis removible | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 7 | paciente o tutor legal | CONSENTIMIENTO DE REHABILITACIÓN ORAL PRÓTESIS REMOVIBLE PROCEDIMIENTO(S) _______________________________________________________________ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y co |
| CONS_REHAB_IMPLANTES | Consentimiento informado de rehabilitación oral sobre implantes | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 7 | paciente o tutor legal | CONSENTIMIENTO INFORMADO DE REHABILITACIÓN ORAL SOBRE IMPLANTES PROCEDIMIENTO(S) _______________________________________________________________ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesg |
| CONS_APROBACION_ESTETICA | Aprobación estética de rehabilitación oral | Constancias y reconocimientos | BLOCKED | BLOCKED | SPECIAL_WORKFLOW | documento especial |  |  | Requiere un flujo especial todavía no implementado para consentimientos comunes. |
| CONS_URGENCIA | Consentimiento informado de urgencia odontológica | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_OR_RESPONSIBLE_ADULT | texto disyuntivo | 5 | paciente o tutor legal | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_OXIDO_NITROSO | Consentimiento informado de óxido nitroso | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | RESPONSIBLE_ADULT_REQUIRED | representante real | 5 | LACTANTES | Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{sit |
| CONS_PLANO_RELAJACION | Consentimiento informado de plano de relajación y estabilización | Consentimientos clínicos | NEEDS_REVIEW | NEEDS_REVIEW | PATIENT_SELF | adulto en nombre propio |  |  | Apto para adulto en nombre propio; pendiente equivalencia humana. |
| CONS_RETIRO_ORTODONCIA | Retiro anticipado de ortodoncia y paciente externo | Constancias y reconocimientos | BLOCKED | BLOCKED | SPECIAL_WORKFLOW | documento especial |  |  | Requiere un flujo especial todavía no implementado para consentimientos comunes. |
| IND_CIRUGIA | Indicaciones de cirugía | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_CIRUGIA_IMPLANTES | Indicaciones de cirugía de implantes | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_ENDODONCIA | Indicaciones de endodoncia | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_BLANQUEAMIENTO | Indicaciones de blanqueamiento | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_FLUOR_BARNIZ | Aplicación de flúor barniz | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_OBTURACIONES_RESINA | Indicaciones de obturaciones en resina | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_DESTARTRAJE | Indicaciones para destartraje | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_ODONTOPEDIATRIA_GENERAL | Indicaciones generales de odontopediatría | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_ORTODONCIA | Indicaciones de ortodoncia | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_PERIODONCIA | Indicaciones de periodoncia | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_PREOP_CIRUGIA_MAXILOFACIAL | Indicaciones preoperatorias de cirugía menor maxilofacial | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_REHABILITACION_ORAL | Indicaciones de rehabilitación oral | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |
| IND_TRAUMA_DENTOALVEOLAR | Indicaciones de odontopediatría trauma dentoalveolar | Indicaciones | BLOCKED | BLOCKED | NO_PATIENT_SIGNATURE | no requiere firma |  |  | Documento de indicaciones/certificado. No requiere firma de consentimiento. |

## Documentos prioritarios

### CONS_ORTODONCIA — Consentimiento informado de ortodoncia

- Compatible PATIENT_SELF tal como está: No
- Línea que bloquea: 5
- Término: paciente/apoderado
- Sigue en normalized_content: Sí
- Requiere variante adulta: Sí
- Requiere adulto responsable: No
- Apto para flujo electrónico local: No
- Motivo: El texto contempla paciente y representante. El flujo electrónico actual solo permite adultos que actúan en nombre propio.

### CONS_CIRUGIA — Consentimiento informado de cirugía odontológica

- Compatible PATIENT_SELF tal como está: No
- Línea que bloquea: 5
- Término: tutor acompañante
- Sigue en normalized_content: Sí
- Requiere variante adulta: Sí
- Requiere adulto responsable: No
- Apto para flujo electrónico local: No
...
### CONS_DESTARTRAJE_OPERATORIA — Consentimiento de destartraje y operatoria dental

- Compatible PATIENT_SELF tal como está: No
- Línea que bloquea: 7
- Término: paciente o tutor legal
- Sigue en normalized_content: Sí
- Requiere variante adulta: Sí
- Requiere adulto responsable: No
- Apto para flujo electrónico local: No
...
### CONS_IMPLANTOLOGIA — Consentimiento informado de implantología
...
### CONS_ENDODONCIA — Consentimiento informado de endodoncia

- Compatible PATIENT_SELF tal como está: Sí
- Línea que bloquea: 5
- Término: siendo responsable
- Sigue en normalized_content: Sí
- Requiere variante adulta: No
- Requiere adulto responsable: No
- Apto para flujo electrónico local: Sí
- Motivo: Apto para adulto en nombre propio; pendiente equivalencia humana.

### CONS_OBTURACION_DIRECTA — Consentimiento informado de obturación directa
...
### CONS_PERIODONCIA — Consentimiento informado de periodoncia
...
### CONS_URGENCIA — Consentimiento informado de urgencia odontológica
...
## Variantes adultas propuestas

### CONS_BLANQUEAMIENTO — Consentimiento informado de blanqueamiento dental

- Línea: 5
- Término: paciente o tutor legal
- Texto original:

> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO BLANQUEAMIENTO DENTAL El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El blanqueamiento dental es un procedimiento odontológico que tiene por objetivo aclarar el color del diente utilizando agentes químicos como el peróxido de hidrógeno o carbamida sobre la superficie

- Texto propuesto:

> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO BLANQUEAMIENTO DENTAL El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El blanqueamiento dental es un procedimiento odontológico que tiene por objetivo aclarar el color del diente utilizando agentes químicos como el peróxido de hidrógeno o carbamida sobre la superficie

- Justificación: El texto fuente mezcla paciente adulto y representante. La variante adulta propuesta conserva el sentido para paciente que actúa en nombre propio, pero requiere equivalencia clínica y jurídica.
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO BLANQUEAMIENTO DENTAL El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El blanqueamiento dental es un procedimiento odontológico que tiene por objetivo aclarar el color del diente utilizando agentes químicos como el peróxido de hidrógeno o carbamida sobre la superficie del
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO DE ORTODONCIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. El tratamiento de ortodoncia consiste en la corrección y alinea
...
### CONS_DESTARTRAJE — Consentimiento informado de destartraje

- Línea: 5
- Término: paciente o tutor legal
- Texto original:

> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE DESTARTRAJE El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El destartraje supragingival y pulido coronario o limpieza dental consiste en la remoción del tártaro dental (sarro) adherido a la superficie del diente que se encuentra por sobre la encía (suprag
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE DESTARTRAJE El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El destartraje supragingival y pulido coronario o limpieza dental consiste en la remoción del tártaro dental (sarro) adherido a la superficie del diente que se encuentra por sobre la encía (supraging
...
### CONS_OBTURACION_BASE — Consentimiento informado de obturación directa con base cavitaria

- Línea: 5
- Término: paciente o tutor legal
- Texto original:

> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE OBTURACION DIRECTA CON BASE CAVITARIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: Las obturaciones (tapaduras) permiten restaurar el diente a través de un material artificial biocompatible con el diente el cual se pega mediante un sistema adhesivo. El
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE OBTURACION DIRECTA CON BASE CAVITARIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: Las obturaciones (tapaduras) permiten restaurar el diente a través de un material artificial biocompatible con el diente el cual se pega mediante un sistema adhesivo. El tra
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE PERIODONCIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El tratamiento periodontal consiste en la remoción del tártaro dental (sarro) adherido a la superficie del diente o los tejidos de soporte (periodonto). Se busca la eliminación de la infección, in
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE PERIODONCIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El tratamiento periodontal consiste en la remoción del tártaro dental (sarro) adherido a la superficie del diente o los tejidos de soporte (periodonto). Se busca la eliminación de la infección, infla
...
### CONS_PROTESIS_FIJA — Consentimiento informado de rehabilitación oral prótesis fija
...
> Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO DE URGENCIA El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. Asisto por urgencia odontológica y luego de una evaluación clínic
...
- Tipo: CERTIFICATE
- Estado: **BLOCKED**
- Firmante: `NO_PATIENT_SIGNATURE`
- Causa: no requiere firma
- Línea/contexto: No aplica — Documento de indicaciones/certificado. No requiere firma de consentimiento.
- Alertas: ['document_does_not_require_patient_signature:CERTIFICATE']
...
- Estado: **NEEDS_REVIEW**
- Firmante: `PATIENT_OR_RESPONSIBLE_ADULT`
- Causa: texto disyuntivo
- Línea/contexto: 5 — Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO BLANQUEAMIENTO DENTAL El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: El blanqueamiento dental es un procedimiento odontológico que tiene por objetivo aclarar el color del diente utilizando agentes químicos como el peróxido de hidrógeno o carbamida sobre la superficie
...
- Estado: **BLOCKED**
- Firmante: `SPECIAL_WORKFLOW`
- Causa: documento especial
- Línea/contexto: No aplica — Requiere un flujo especial todavía no implementado para consentimientos comunes.
...
- Firmante: `PATIENT_OR_RESPONSIBLE_ADULT`
- Causa: texto disyuntivo
- Línea/contexto: 7 — CONSENTIMIENTO DESTARTRAJE Y OPERATORIA DENTAL Declaro haber informado de forma clara y veraz a el / la odontólogo/a tratante respecto a mi estado de salud general, condiciones médicas u odontológicas, tratamientos previos y actuales, alergias, cirugías previas y fármacos que utilizo o cualquier otro antecedente. El/la odontólogo/a tratante me ha informado respecto a mi estado de salud bucal y resuelto mis dudas e inquietudes respecto al mismo. Me ha explicado también los tratamientos propuestos junto a las ventajas y desventajas, al igual que los riesgos, beneficios y posibles complicaciones en caso de realizar o no realizar el tratamiento mencionado. Me ha informado respecto a la posible n
- Alertas: ['localized_terms_require_human_review']
...
- Firmante: `PATIENT_OR_RESPONSIBLE_ADULT`
- Causa: texto disyuntivo
- Línea/contexto: 7 — CONSENTIMIENTO IMPLANTOLOGÍA PROCEDIMIENTO ___ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. El tratamiento de implantes consiste en la instalación de un tornillo de titanio en el hueso, el que debe osteointegrarse pudiendo tardar desde 3 a 6 meses antes de ser conectado a través de tornillos protésicos para continuar con la corona sobre implantes. El implante reemplaza la raíz del diente, por lo qu
- Alertas: ['localized_terms_require_human_review']
...
- Tipo: INFORMED_CONSENT
- Estado: **NEEDS_REVIEW**
- Firmante: `RESPONSIBLE_ADULT_REQUIRED`
- Causa: contenido pediátrico
- Línea/contexto: 1 — # Consentimiento informado de odontopediatría Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}}
- Alertas: ['localized_terms_require_human_review']
...
- Firmante: `RESPONSIBLE_ADULT_REQUIRED`
- Causa: contenido pediátrico
- Línea/contexto: 1 — # Consentimiento informado de odontopediatría Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}}
- Alertas: ['localized_terms_require_human_review']
...
- Tipo: INFORMED_CONSENT
- Estado: **NEEDS_REVIEW**
- Firmante: `PATIENT_SELF`
- Causa: término administrativo
- Línea/contexto: 5 — Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Colombia Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE ENDODONCIA PROCEDIMIENTO _____ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. El tratamiento endodóntico (de
- Alertas: ['localized_terms_require_human_review']
...
- Firmante: `PATIENT_SELF`
- Causa: término administrativo
- Línea/contexto: 5 — Paciente: {{patient.full_name}} Identificación: {{patient.document_type}} {{patient.document_number}} Fecha clínica: {{document.clinical_date}} País documental: Chile Clínica: {{company.name}} Sede: {{site.name}} Dirección de sede: {{site.address}}, {{site.city}} CONSENTIMIENTO INFORMADO DE ENDODONCIA PROCEDIMIENTO _____ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. El tratamiento endodóntico (de co
- Alertas: ['localized_terms_require_human_review']
...
- Firmante: `PATIENT_OR_RESPONSIBLE_ADULT`
- Causa: texto disyuntivo
- Línea/contexto: 7 — CONSENTIMIENTO DE REHABILITACIÓN ORAL PRÓTESIS REMOVIBLE PROCEDIMIENTO(S) _______________________________________________________________ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. La rehabilitación oral busca devolver dientes perdidos mediante el uso de elementos artificiales protésicos, dentro de las prótesis removibles se encuentra la prótesis total, prótesis parcial de base acrílica, parcial
- Alertas: ['localized_terms_require_human_review']
...
- Firmante: `PATIENT_OR_RESPONSIBLE_ADULT`
- Causa: texto disyuntivo
- Línea/contexto: 7 — CONSENTIMIENTO INFORMADO DE REHABILITACIÓN ORAL SOBRE IMPLANTES PROCEDIMIENTO(S) _______________________________________________________________ El odontólogo tratante ha resuelto mis dudas e inquietudes, me ha explicado las ventajas, riesgos y complicaciones del uso de fármacos, anestésicos y del procedimiento a realizar, entendiendo que: He entregado información real, fidedigna y veraz en cuanto a mi historial clínico, enfermedades sistémicas, hábitos y consumo de alcohol o drogas. La rehabilitación oral sobre implantes busca devolver dientes perdidos mediante el uso de elementos artificiales protésicos que se anclan a través de tornillos o se cementan en los implantes de titanio integrado
- Alertas: ['localized_terms_require_human_review']
...
- Estado: **NEEDS_REVIEW**
- Firmante: `PATIENT_SELF`
- Causa: adulto en nombre propio
- Línea/contexto: No aplica — Apto para adulto en nombre propio; pendiente equivalencia humana.
- Alertas: ['localized_terms_require_human_review']
...
- Causa: no requiere firma
- Línea/contexto: No aplica — Documento de indicaciones/certificado. No requiere firma de consentimiento.
- Alertas: ['document_does_not_require_patient_signature:POST_CARE_INSTRUCTIONS']
...
- Causa: no requiere firma
- Línea/contexto: No aplica — Documento de indicaciones/certificado. No requiere firma de consentimiento.
- Alertas: ['document_does_not_require_patient_signature:POST_CARE_INSTRUCTIONS', 'localized_terms_require_human_review']
...
- Causa: no requiere firma
- Línea/contexto: No aplica — Documento de indicaciones/certificado. No requiere firma de consentimiento.
- Alertas: ['document_does_not_require_patient_signature:PRE_CARE_INSTRUCTIONS']
