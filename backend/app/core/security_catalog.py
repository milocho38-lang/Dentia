...
PERMISSIONS = (
    ...
    PermissionDefinition("periodontogram.view", "Ver periodontogramas", "periodontogram", "Consultar periodontogramas e historial autorizado del paciente."),
    PermissionDefinition("periodontogram.create", "Crear periodontogramas", "periodontogram", "Crear un control periodontal independiente en borrador."),
    PermissionDefinition("periodontogram.update_draft", "Actualizar borradores de periodontograma", "periodontogram", "Modificar datos periodontales mientras la versión esté en borrador."),
    PermissionDefinition("periodontogram.finalize", "Finalizar periodontogramas", "periodontogram", "Finalizar y congelar una versión de periodontograma."),
    PermissionDefinition("periodontogram.correct", "Corregir periodontogramas", "periodontogram", "Crear una nueva versión correctiva sin alterar el histórico finalizado."),
    PermissionDefinition("periodontogram.pilot.view", "Ver piloto de Periodontograma", "periodontogram", "Consultar la habilitación piloto de Periodontograma y sus odontólogos autorizados."),
    PermissionDefinition("periodontogram.pilot.manage", "Administrar piloto de Periodontograma", "periodontogram", "Habilitar el piloto por empresa y autorizar o revocar odontólogos participantes."),
