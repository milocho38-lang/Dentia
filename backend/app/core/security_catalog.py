...
PERMISSIONS = (
    ...
    PermissionDefinition("odontogram.create", "Crear odontograma", "odontogram", "Crear cabecera de odontograma para pacientes con historia clínica."),
    PermissionDefinition("odontogram.update_draft", "Actualizar borradores de odontograma", "odontogram", "Editar eventos odontográficos en borrador."),
    PermissionDefinition("odontogram.confirm", "Confirmar eventos de odontograma", "odontogram", "Confirmar eventos odontográficos y calcular hash de integridad."),
    PermissionDefinition("odontogram.correct", "Corregir eventos de odontograma", "odontogram", "Registrar correcciones o eventos compensatorios sobre eventos confirmados."),
    PermissionDefinition("odontogram.history", "Ver histórico de odontograma", "odontogram", "Consultar histórico odontográfico por diente o superficie."),
    ...
    PermissionDefinition("clinical_documents.view", "Ver informes clínicos", "clinical_documents", "Consultar informes, remisiones, certificados y cartas clínicas."),
    PermissionDefinition("clinical_documents.create", "Crear informes clínicos", "clinical_documents", "Crear borradores de informes, remisiones, certificados y cartas clínicas."),
    PermissionDefinition("clinical_documents.edit_draft", "Editar borradores de informes", "clinical_documents", "Editar documentos clínicos narrativos en borrador."),
    PermissionDefinition("clinical_documents.finalize", "Finalizar informes clínicos", "clinical_documents", "Finalizar documentos clínicos y generar PDF institucional."),
    PermissionDefinition("clinical_documents.download", "Descargar informes clínicos", "clinical_documents", "Descargar PDFs clínicos almacenados."),
    PermissionDefinition("clinical_documents.void", "Anular informes clínicos", "clinical_documents", "Anular documentos clínicos finalizados conservando histórico."),
    PermissionDefinition("prescriptions.view", "Ver recetas", "prescriptions", "Consultar recetas odontológicas autorizadas."),
    PermissionDefinition("prescriptions.create", "Crear recetas", "prescriptions", "Crear borradores de recetas odontológicas."),
    PermissionDefinition("prescriptions.edit_draft", "Editar borradores de recetas", "prescriptions", "Editar recetas odontológicas en borrador."),
    ...
    PermissionDefinition("consent.instance.review", "Revisar consentimientos clínicamente", "consent_instances", "Confirmar profesionalmente el contenido antes de firma."),
